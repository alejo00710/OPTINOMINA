...
export const DEFAULT_FORMULAS = {
  ...
  salud: '(total_devengados - transporte - rodamiento) * 0.04',
  pension: '(total_devengados - transporte - rodamiento) * 0.04',
  solidaridad: '(total_devengados - transporte - rodamiento) >= (smlv_base * 4) ? (total_devengados - transporte - rodamiento) * 0.01 : 0',
